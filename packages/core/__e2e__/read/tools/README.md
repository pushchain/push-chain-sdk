# Read-state E2E tools

Reference harness for exercising cross-chain read state against **live Donut**. Used for the
first end-to-end reads on 2026-09-09 ([SDK spec](../../../../../plan/read-state-sdk-spec.md) § Verified live).
