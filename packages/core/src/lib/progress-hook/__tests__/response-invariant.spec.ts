...
const STUB_ARGS: Record<PROGRESS_HOOK, unknown[]> = {
  ...
  [PROGRESS_HOOK.SEND_TX_103_03]: ['eip155:11155111', BigInt(100_000_000)],
  [PROGRESS_HOOK.SEND_TX_103_03_01]: ['eip155:11155111', BigInt('500000000000000000'), BigInt('500000000000000000'), BigInt(100_000_000)],
  [PROGRESS_HOOK.SEND_TX_103_03_02]: ['eip155:11155111', BigInt('5000000000000000000'), BigInt(0), BigInt(500_000_000)],
  [PROGRESS_HOOK.SEND_TX_103_03_03]: ['eip155:11155111', BigInt('10000000000000000000'), BigInt('5000000000000000000'), BigInt(1_500_000_000)],
  [PROGRESS_HOOK.SEND_TX_103_03_04]: [BigInt('1000000000000000000'), BigInt(100_000_000), 'eip155:11155111'],
  ...
  [PROGRESS_HOOK.SEND_TX_299_02]: ['eip155:11155111', 'err'],
  ...
  [PROGRESS_HOOK.SEND_TX_002_99_99]: [1, 3],
  ...
  [PROGRESS_HOOK.SEND_TX_999_01]: [3],
  [PROGRESS_HOOK.SEND_TX_999_02]: [2, 3, 'cea revert'],
  [PROGRESS_HOOK.SEND_TX_999_03]: [2, 3],
  // Migration
  ...
  [PROGRESS_HOOK.READ_TX_102_02]: [BigInt(0), BigInt(5), BigInt(5), BigInt(100), BigInt(200)],
  [PROGRESS_HOOK.READ_TX_102_03]: ['eip155:1'],
  [PROGRESS_HOOK.READ_TX_102_04]: [1000, 61000],
  [PROGRESS_HOOK.READ_TX_102_05]: ['0xrefund'],
  [PROGRESS_HOOK.READ_TX_103_01]: [BigInt(10), BigInt(20)],
  [PROGRESS_HOOK.READ_TX_103_02]: [BigInt(20), BigInt(10)],
  [PROGRESS_HOOK.READ_TX_103_03]: [['authorization']],
  [PROGRESS_HOOK.READ_TX_104_01]: [],
  [PROGRESS_HOOK.READ_TX_104_02]: ['0xtxhash', '0xrequest', 0],
  [PROGRESS_HOOK.READ_TX_104_03]: [{ requestId: '0xrequest' }],
  [PROGRESS_HOOK.READ_TX_104_04]: ['0xrequest', 'FULFILLED'],
  [PROGRESS_HOOK.READ_TX_104_05]: [{ requestId: '0xrequest' }, 30000],
  [PROGRESS_HOOK.READ_TX_105_01]: ['0xrequest'],
  [PROGRESS_HOOK.READ_TX_105_02]: ['0xrequest'],
  [PROGRESS_HOOK.READ_TX_105_03]: ['0xrequest', BigInt(1), BigInt(3)],
  [PROGRESS_HOOK.READ_TX_105_04]: ['0xrequest', BigInt(12)],
  [PROGRESS_HOOK.READ_TX_106_01]: ['0xrequest', '0xtarget'],
  [PROGRESS_HOOK.READ_TX_106_02]: ['0xrequest'],
  [PROGRESS_HOOK.READ_TX_106_03]: ['0xrequest', '0xdead'],
  [PROGRESS_HOOK.READ_TX_106_04]: ['0xrequest', BigInt(7), BigInt(3)],
  [PROGRESS_HOOK.READ_TX_106_05]: ['0xrequest', BigInt(3), '0xrefund'],
  [PROGRESS_HOOK.READ_TX_106_06]: ['0xrequest', BigInt(3), '0xrefund'],
  [PROGRESS_HOOK.READ_TX_199_01]: ['0xrequest', BigInt(42), '0x2a', true],
  [PROGRESS_HOOK.READ_TX_199_02]: ['0xrequest', 'EXPIRED', undefined, '', BigInt(5)],
  [PROGRESS_HOOK.READ_TX_199_03]: ['0xrequest', 'VOTING', 180000],
  [PROGRESS_HOOK.READ_TX_199_99]: ['0xrequest', '0xtxhash'],
  [PROGRESS_HOOK.READ_TX_001]: [2, ['eip155:11155111', 'web2:https']],
  [PROGRESS_HOOK.READ_TX_002_01]: [1, 2, 'eip155:11155111'],
  [PROGRESS_HOOK.READ_TX_002_99_99]: [1, 2, '0xrequest'],
  [PROGRESS_HOOK.READ_TX_999_01]: [2],
  [PROGRESS_HOOK.READ_TX_999_02]: [2, 3, 'boom'],
  [PROGRESS_HOOK.READ_TX_999_03]: [2, 3],
};
