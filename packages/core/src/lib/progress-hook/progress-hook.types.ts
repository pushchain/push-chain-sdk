...
export enum PROGRESS_HOOK {
  ...
  SEND_TX_202_03_A = 'SEND-TX-202-03-A', // Sizer: Case A (< $1, padded)
  SEND_TX_202_03_B = 'SEND-TX-202-03-B', // Sizer: Case B ($1–$10, happy path)
  SEND_TX_202_03_C = 'SEND-TX-202-03-C', // Sizer: Case C (> $10, split + overflow bridge)
